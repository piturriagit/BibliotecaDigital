    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'published_year' => 1949,
                'path' => 'upload/books/famouspaintings.epub',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'title' => 'Only mandatory fields',
                'path' => 'upload/books/Sway.epub',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'title' => 'Only mandatory fields',
                'path' => 'upload/books/Around the World in 28 Languages.epub',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ]
        ];
